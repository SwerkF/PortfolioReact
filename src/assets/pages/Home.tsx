...
const Home = () => {
    ...
    return (
        <>
            ...
            <Certifs />
            <svg style={{backgroundColor: 'var(--primary)'}} xmlns="https://www.w3.org/2000/svg" viewBox="0 0 1440 320">
            ...
            <svg style={{backgroundColor: '#0b0b0b'}} xmlns="https://www.w3.org/2000/svg" viewBox="0 0 1440 320">
                <path fill="var(--primary)" fillOpacity="1" d="M0,32L48,53.3C96,75,192,117,288,133.3C384,149,480,139,576,117.3C672,96,768,64,864,90.7C960,117,1056,203,1152,234.7C1248,267,1344,245,1392,234.7L1440,224L1440,0L1392,0C1344,0,1248,0,1152,0C1056,0,960,0,864,0C768,0,672,0,576,0C480,0,384,0,288,0C192,0,96,0,48,0L0,0Z"></path>
            </svg>
            <Veilles />
            <svg style={{backgroundColor: '#0b0b0b'}} xmlns="https://www.w3.org/2000/svg" viewBox="0 0 1440 320">
